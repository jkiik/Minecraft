  ...
  for h in range (0,10):
    ...
    for k  in range (0,10):
      ...
      if (theBlock == "6"):
        c = 6 # wool 35,0  WHITE
      if (theBlock == "7"):
        c = 7 # wool 35,0  DARK GRAY
      if (theBlock == "8"):
        c = 8 # wool 35,0  LIGHT GRAY  
      if (theBlock == "9"):
        c = 9 # wool 35,0  WHITE
      if (theBlock == "A"):
        c = 10 # wool 35,0  WHITE
      if (theBlock == "B"):
        c = 11 # wool 35,0  WHITE
      if (theBlock == "C"):
        c = 12 # wool 35,0  WHITE
      if (theBlock == "D"):
        c = 13 # wool 35,0  WHITE
      if (theBlock == "E"):
        c = 14 # wool 35,0  WHITE
      if (theBlock == "F"):
        c = 15 # wool 35,0  BLACK
      if c == -1:
